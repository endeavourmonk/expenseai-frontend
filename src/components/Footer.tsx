      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src="/src/assets/react.svg" className="h-8 w-8" alt="Logo" />
              <span className="text-xl font-semibold">ExpenseAI</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Simplifying financial management with AI-powered tools.
            </p>
          </div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {currentYear} ExpenseAI. All rights reserved.
          </p>
